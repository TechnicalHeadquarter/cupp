...
#  http://www.youtube.com/TechnicalHeadquarter
#
#  [License]
#
...
def print_cow():
    ...
    print(
        "           \033[1;31m   ||--|| \033[1;m\033[05m*\033[25m\033[1;m      [ Syed | youtube.com/TechnicalHeadquarter ]"
    )
    print(28 * " " + "[ Shoaib Raza | https://github.com/TechnicalHeadquarter/]\r\n")
...
def version():
    ...
    print("	* Hacked up by Syed - Github.com/TechnicalHeadquarter")
    print("	* Youtube.com/TechnicalHeadquarter\r\n")
...
def interactive():
    ...
    if words1 == "y":
        words2 = input(
            "> Please enter the words, separated by comma. [i.e. hacker,juice,black,TechnicalHeadquarter], spaces will be removed: "
        ).replace(" ", "")
